...
def chat_bot(email,username,thread_id):
    ...
    with col2:
        ...
        if 'generated' not in st.session_state:
            st.session_state['generated'] = ["Greetings! Thank you for the transaction you made last week, "+username+". \n Are you contacting us about your last purchase?"]
